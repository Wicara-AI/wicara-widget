import {
  InboundInteractiveType,
  InboundMessageType,
} from '../constants/inboundMessage'
...
export type SenderModel = (typeof SenderModel)[keyof typeof SenderModel]
...
export type InboundInteractiveListMessage = InboundInitMessage &
  InboundInitInteractiveMessage<{
...
export type InboundUnsupportedMessage = InboundInitMessage &
  InboundInitInteractiveMessage<{
...
export type InboundInteractiveButtonMessage = InboundInitMessage &
  InboundInitInteractiveMessage<{
...
export type InboundInteractiveCarouselMessage = InboundInitMessage &
  InboundInitInteractiveMessage<{
